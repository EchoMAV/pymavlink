...
public class MAV_TYPE {
   ...
   public static final int MAV_TYPE_RELAY = 64; /* MAVNet Comms Multiplexor | */
   public static final int MAV_TYPE_SWITCHBOX = 65; /* MAVNet Switch Box | */
   public static final int MAV_TYPE_WEATHERPAK = 66; /* MAVNet Weather Station | */
   public static final int MAV_TYPE_SENSOR = 67; /* MAVNet General Purpose Sensor | */
   public static final int MAV_TYPE_BEACON = 68; /* MAVNet Beacon Asset | */
   public static final int MAV_TYPE_SAMPLER = 69; /* MAVNet General Purpose Actuator | */
