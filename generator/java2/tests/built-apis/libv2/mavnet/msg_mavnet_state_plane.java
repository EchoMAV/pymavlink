...
// MESSAGE MAVNET_STATE_PLANE PACKING
...
/**
 * MAVNet state message for a fixed-wing, quadplane, VTOL
 */
public class msg_mavnet_state_plane extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_MAVNET_STATE_PLANE = 43011;
    public static final int MAVLINK_MSG_LENGTH = 233;
    private static final long serialVersionUID = MAVLINK_MSG_ID_MAVNET_STATE_PLANE;
    ...
    /**
     * Current revolutions per minute of the motor
     */
    public int motor_rpm;
    ...
    /**
     * Remaining liquid fuel: (0%: 0, 100%: 100)
     */
    ...
    public MAVLinkPacket pack() {
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_MAVNET_STATE_PLANE;
        ...
        packet.payload.putUnsignedShort(motor_rpm);
        ...
        packet.payload.putUnsignedByte(fuel_level);
    ...
    /**
     * Decode a mavnet_state_plane message into this class fields
     *
    ...
    public void unpack(MAVLinkPayload payload) {
        ...
        this.motor_rpm = payload.getUnsignedShort();
        ...
        this.fuel_level = payload.getUnsignedByte();
     ...
     */
    public msg_mavnet_state_plane() {
        msgid = MAVLINK_MSG_ID_MAVNET_STATE_PLANE;
    }
     ...
     *
     */
    public msg_mavnet_state_plane(MAVLinkPacket mavLinkPacket) {
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_MAVNET_STATE_PLANE;
