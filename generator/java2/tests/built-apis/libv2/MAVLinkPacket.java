...
import com.mavlink.mavnet.CRC;

import com.mavlink.mavnet.*;
...
public class MAVLinkPacket implements Serializable {
    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_mavnet_command.MAVLINK_MSG_ID_MAVNET_COMMAND:
                return  new msg_mavnet_command(this);
             
            case msg_mavnet_comm_group_configuration.MAVLINK_MSG_ID_MAVNET_COMM_GROUP_CONFIGURATION:
                return  new msg_mavnet_comm_group_configuration(this);
             
            case msg_mavnet_param_request_read.MAVLINK_MSG_ID_MAVNET_PARAM_REQUEST_READ:
                return  new msg_mavnet_param_request_read(this);
             
            case msg_mavnet_param_set.MAVLINK_MSG_ID_MAVNET_PARAM_SET:
                return  new msg_mavnet_param_set(this);
             
            case msg_mavnet_state_parameters.MAVLINK_MSG_ID_MAVNET_STATE_PARAMETERS:
                return  new msg_mavnet_state_parameters(this);
             
            case msg_mavnet_message.MAVLINK_MSG_ID_MAVNET_MESSAGE:
                return  new msg_mavnet_message(this);
             
            case msg_mavnet_mission_transfer.MAVLINK_MSG_ID_MAVNET_MISSION_TRANSFER:
                return  new msg_mavnet_mission_transfer(this);
             
            case msg_mavnet_comm_registration.MAVLINK_MSG_ID_MAVNET_COMM_REGISTRATION:
                return  new msg_mavnet_comm_registration(this);
             
            case msg_mavnet_state_copter.MAVLINK_MSG_ID_MAVNET_STATE_COPTER:
                return  new msg_mavnet_state_copter(this);
             
            case msg_mavnet_state_rover.MAVLINK_MSG_ID_MAVNET_STATE_ROVER:
                return  new msg_mavnet_state_rover(this);
             
            case msg_mavnet_state_plane.MAVLINK_MSG_ID_MAVNET_STATE_PLANE:
                return  new msg_mavnet_state_plane(this);
             
            case msg_mavnet_state_relay.MAVLINK_MSG_ID_MAVNET_STATE_RELAY:
                return  new msg_mavnet_state_relay(this);
             
            case msg_mavnet_state_beacon.MAVLINK_MSG_ID_MAVNET_STATE_BEACON:
                return  new msg_mavnet_state_beacon(this);
             
            case msg_mavnet_state_switchbox.MAVLINK_MSG_ID_MAVNET_STATE_SWITCHBOX:
                return  new msg_mavnet_state_switchbox(this);
             
            case msg_mavnet_state_weatherpak.MAVLINK_MSG_ID_MAVNET_STATE_WEATHERPAK:
                return  new msg_mavnet_state_weatherpak(this);
             
            case msg_mavnet_state_sensor.MAVLINK_MSG_ID_MAVNET_STATE_SENSOR:
                return  new msg_mavnet_state_sensor(this);
