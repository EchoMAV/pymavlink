...
import com.mavlink.ornl.CRC;
import com.mavlink.common.*;
import com.mavlink.ornl.*;
    ...
    */
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_arc_command.MAVLINK_MSG_ID_ARC_COMMAND:
                return  new msg_arc_command(this);
                 
            case msg_arc_state_quadcopter.MAVLINK_MSG_ID_ARC_STATE_QUADCOPTER:
                return  new msg_arc_state_quadcopter(this);
                 
            case msg_arc_state_rover.MAVLINK_MSG_ID_ARC_STATE_ROVER:
                return  new msg_arc_state_rover(this);
                 
            case msg_arc_parameter.MAVLINK_MSG_ID_ARC_PARAMETER:
                return  new msg_arc_parameter(this);
                 
            case msg_arc_state_relay.MAVLINK_MSG_ID_ARC_STATE_RELAY:
                return  new msg_arc_state_relay(this);
                 
            case msg_arc_state_beacon.MAVLINK_MSG_ID_ARC_STATE_BEACON:
                return  new msg_arc_state_beacon(this);
                 
            case msg_arc_state_plane.MAVLINK_MSG_ID_ARC_STATE_PLANE:
                return  new msg_arc_state_plane(this);
                 
            case msg_arc_state_switchbox.MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX:
                return  new msg_arc_state_switchbox(this);
                 
            case msg_arc_state_weatherpak.MAVLINK_MSG_ID_ARC_STATE_WEATHERPAK:
                return  new msg_arc_state_weatherpak(this);
                 
            case msg_arc_message.MAVLINK_MSG_ID_ARC_MESSAGE:
                return  new msg_arc_message(this);
                 
            case msg_arc_mission_transfer.MAVLINK_MSG_ID_ARC_MISSION_TRANSFER:
                return  new msg_arc_mission_transfer(this);
                 
            case msg_ornl_set_system_mode.MAVLINK_MSG_ID_ORNL_SET_SYSTEM_MODE:
                return  new msg_ornl_set_system_mode(this);
                 
            case msg_ornl_comm_registration.MAVLINK_MSG_ID_ORNL_COMM_REGISTRATION:
                return  new msg_ornl_comm_registration(this);
                 
            case msg_arc_parameters.MAVLINK_MSG_ID_ARC_PARAMETERS:
                return  new msg_arc_parameters(this);
                 
            case msg_ornl_comm_group_configuration.MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION:
                return  new msg_ornl_comm_group_configuration(this);
