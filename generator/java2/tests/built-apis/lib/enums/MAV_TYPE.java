...
public class MAV_TYPE {
   ...
   public static final int MAV_TYPE_RELAY = 64; /* ORNL Comms Multiplexor | */
   public static final int MAV_TYPE_SWITCHBOX = 65; /* ORNL Switch Box containing Edison, Iridium, GPS and Switch | */
   public static final int MAV_TYPE_WEATHERPAK = 66; /* ORNL Weather Station | */
   public static final int MAV_TYPE_CHEM_SENSOR = 67; /* ORNL Chemical Sensor | */
   public static final int MAV_TYPE_BEACON = 68; /* ORNL Beacon Asset | */
   public static final int MAV_TYPE_SAMPLER = 69; /* ORNL Beacon Asset | */
   public static final int MAV_TYPE_ENUM_END = 70; /*  | */
}
