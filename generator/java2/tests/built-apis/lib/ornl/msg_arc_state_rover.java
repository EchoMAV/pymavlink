...
// MESSAGE ARC_STATE_ROVER PACKING
...
/**
* ArcSoft state message for a rover.
*/
public class msg_arc_state_rover extends MAVLinkMessage{

    public static final int MAVLINK_MSG_ID_ARC_STATE_ROVER = 222;
    public static final int MAVLINK_MSG_LENGTH = 156;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ARC_STATE_ROVER;
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_ARC_STATE_ROVER;
    ...
    /**
    * Decode a arc_state_rover message into this class fields
    *
    ...
    */
    public msg_arc_state_rover(){
        msgid = MAVLINK_MSG_ID_ARC_STATE_ROVER;
    }
    ...
    *
    */
    public msg_arc_state_rover(MAVLinkPacket mavLinkPacket){
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_ARC_STATE_ROVER;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_ARC_STATE_ROVER -"+" state_sequence:"+state_sequence+" time_usec:"+time_usec+" command_sequence:"+command_sequence+" destination_latitude:"+destination_latitude+" destination_longitude:"+destination_longitude+" destination_altitude_ahl:"+destination_altitude_ahl+" target_latitude:"+target_latitude+" target_longitude:"+target_longitude+" target_altitude_ahl:"+target_altitude_ahl+" home_latitude:"+home_latitude+" home_longitude:"+home_longitude+" home_altitude_amsl:"+home_altitude_amsl+" mission_delay:"+mission_delay+" rally_point_1_latitude:"+rally_point_1_latitude+" rally_point_1_longitude:"+rally_point_1_longitude+" rally_point_2_latitude:"+rally_point_2_latitude+" rally_point_2_longitude:"+rally_point_2_longitude+" custom_mode:"+custom_mode+" latitude:"+latitude+" longitude:"+longitude+" altitude_amsl:"+altitude_amsl+" groundspeed:"+groundspeed+" mission_sequence:"+mission_sequence+" wp_radius:"+wp_radius+" fs_batt_voltage:"+fs_batt_voltage+" fence_alt_max:"+fence_alt_max+" fence_radius:"+fence_radius+" rtl_alt:"+rtl_alt+" wpnav_speed:"+wpnav_speed+" fs_arc_rangefinder_alt:"+fs_arc_rangefinder_alt+" rally_point_1_ahl:"+rally_point_1_ahl+" rally_point_2_ahl:"+rally_point_2_ahl+" heading:"+heading+" voltage_battery:"+voltage_battery+" system_type:"+system_type+" subscription:"+subscription+" pause:"+pause+" speed:"+speed+" mission_id:"+mission_id+" mission_active:"+mission_active+" mission_upload:"+mission_upload+" fs_batt_enable:"+fs_batt_enable+" fence_enable:"+fence_enable+" fs_thr_enable:"+fs_thr_enable+" fs_ekf_action:"+fs_ekf_action+" fs_arc_rangefinder:"+fs_arc_rangefinder+" transmit_interface:"+transmit_interface+" los_rssi:"+los_rssi+" cellular_rssi:"+cellular_rssi+" satellite_rssi:"+satellite_rssi+" base_mode:"+base_mode+" system_status:"+system_status+" gps_fix_type:"+gps_fix_type+" gps_satellites_visible:"+gps_satellites_visible+" battery_remaining:"+battery_remaining+"";
    }
}
