...
supportedLanguages = ["C", "CS", "CS2", "JavaScript", "TypeScript", "TypeScript2", "Python", "Lua", "WLua", "ObjC", "Swift", "Java", "C++11", "Java2"]
...
def mavgen(opts, args):
    ...
    elif opts.language == 'java2':
        from . import mavgen_java2
        mavgen_java2.generate(opts.output, xml)
