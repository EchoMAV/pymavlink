...
// MESSAGE ARC_MISSION_TRANSFER PACKING
...
/**
* A message informing an ArcSoft system to transfer a mission to or from a requestor.
*/
public class msg_arc_mission_transfer extends MAVLinkMessage{

    public static final int MAVLINK_MSG_ID_ARC_MISSION_TRANSFER = 236;
    public static final int MAVLINK_MSG_LENGTH = 40;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ARC_MISSION_TRANSFER;
    ...
    */
    ...
    /**
    * Direction of the mission transfer (0: Upload to ArcSoft, 1: Download from ArcSoft)
    */
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_ARC_MISSION_TRANSFER;
    ...
    /**
    * Decode a arc_mission_transfer message into this class fields
    *
    ...
    */
    public msg_arc_mission_transfer(){
        msgid = MAVLINK_MSG_ID_ARC_MISSION_TRANSFER;
    }
    ...
    *
    */
    public msg_arc_mission_transfer(MAVLinkPacket mavLinkPacket){
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_ARC_MISSION_TRANSFER;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_ARC_MISSION_TRANSFER -"+" command_sequence:"+command_sequence+" mission_parts:"+mission_parts+" target_system:"+target_system+" transfer_direction:"+transfer_direction+" mission_id:"+mission_id+" mission_name:"+mission_name+"";
    }
}
