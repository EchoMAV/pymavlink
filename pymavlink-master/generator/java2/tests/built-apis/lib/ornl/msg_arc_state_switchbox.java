...
// MESSAGE ARC_STATE_SWITCHBOX PACKING
...
/**
* Data from the ORNL IRIS Switch.
*/
public class msg_arc_state_switchbox extends MAVLinkMessage{

    public static final int MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX = 228;
    public static final int MAVLINK_MSG_LENGTH = 104;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX;
    ...
    */
    ...
    /**
    * The interval between each ARC_STATE_SWITCHBOX message, in microseconds.
    */
    public int interval;
    ...
    */
    ...
    /**
    * CPU temperature measurement (0.01 degrees celsius)
    */
    public short cpu_temperature;
      
    /**
    * Board level temperature measurement (0.01 degrees celsius)
    */
    public short board_temperature;
    ...
    */
    ...
    /**
    * Switch 1 voltage, in millivolts
    */
    public short switch1_voltage;
      
    /**
    * Switch 2 voltage, in millivolts
    */
    public short switch2_voltage;
      
    /**
    * Switch 3 voltage, in millivolts
    */
    public short switch3_voltage;
      
    /**
    * Switch 4 voltage, in millivolts
    */
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX;
        ...
        packet.payload.putShort(cpu_temperature);
              
        packet.payload.putShort(board_temperature);
    ...
    /**
    * Decode a arc_state_switchbox message into this class fields
    *
    ...
    */
    public void unpack(MAVLinkPayload payload) {
        ...
        this.cpu_temperature = payload.getShort();
              
        this.board_temperature = payload.getShort();
    ...
    */
    public msg_arc_state_switchbox(){
        msgid = MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX;
    }
    ...
    *
    */
    public msg_arc_state_switchbox(MAVLinkPacket mavLinkPacket){
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_ARC_STATE_SWITCHBOX -"+" state_sequence:"+state_sequence+" time_usec:"+time_usec+" command_sequence:"+command_sequence+" latitude:"+latitude+" longitude:"+longitude+" altitude_amsl:"+altitude_amsl+" interval:"+interval+" offset:"+offset+" duration:"+duration+" voltage_battery:"+voltage_battery+" cpu_temperature:"+cpu_temperature+" board_temperature:"+board_temperature+" switch1_current:"+switch1_current+" switch2_current:"+switch2_current+" switch3_current:"+switch3_current+" switch4_current:"+switch4_current+" switch1_voltage:"+switch1_voltage+" switch2_voltage:"+switch2_voltage+" switch3_voltage:"+switch3_voltage+" switch4_voltage:"+switch4_voltage+" flow1_setpoint:"+flow1_setpoint+" flow2_setpoint:"+flow2_setpoint+" flow3_setpoint:"+flow3_setpoint+" flow4_setpoint:"+flow4_setpoint+" flow1_rate:"+flow1_rate+" flow2_rate:"+flow2_rate+" flow3_rate:"+flow3_rate+" flow4_rate:"+flow4_rate+" system_type:"+system_type+" subscription:"+subscription+" transmit_interface:"+transmit_interface+" los_rssi:"+los_rssi+" cellular_rssi:"+cellular_rssi+" satellite_rssi:"+satellite_rssi+" battery_remaining:"+battery_remaining+" gps_fix_type:"+gps_fix_type+" gps_satellites_visible:"+gps_satellites_visible+" system_mode:"+system_mode+" switch1_present:"+switch1_present+" switch2_present:"+switch2_present+" switch3_present:"+switch3_present+" switch4_present:"+switch4_present+" switch1_status:"+switch1_status+" switch2_status:"+switch2_status+" switch3_status:"+switch3_status+" switch4_status:"+switch4_status+" flow1_present:"+flow1_present+" flow2_present:"+flow2_present+" flow3_present:"+flow3_present+" flow4_present:"+flow4_present+"";
    }
}
