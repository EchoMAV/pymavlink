...
// MESSAGE ORNL_COMM_GROUP_CONFIGURATION PACKING
...
/**
* ORNL comms configuration - sent from the server to configure a comm system.
*/
public class msg_ornl_comm_group_configuration extends MAVLinkMessage{

    public static final int MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION = 240;
    public static final int MAVLINK_MSG_LENGTH = 41;
    private static final long serialVersionUID = MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION;
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION;
    ...
    /**
    * Decode a ornl_comm_group_configuration message into this class fields
    *
    ...
    */
    public msg_ornl_comm_group_configuration(){
        msgid = MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION;
    }
    ...
    *
    */
    public msg_ornl_comm_group_configuration(MAVLinkPacket mavLinkPacket){
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_ORNL_COMM_GROUP_CONFIGURATION -"+" mavlink_id:"+mavlink_id+" comm_group_name:"+comm_group_name+" callsign:"+callsign+"";
    }
}
