...
// MESSAGE MAVNET_STATE_ROVER PACKING
...
/**
 * MAVNet state message for a rover.
 */
public class msg_mavnet_state_rover extends MAVLinkMessage {

    public static final int MAVLINK_MSG_ID_MAVNET_STATE_ROVER = 43010;
    public static final int MAVLINK_MSG_LENGTH = 202;
    private static final long serialVersionUID = MAVLINK_MSG_ID_MAVNET_STATE_ROVER;
    ...
    public MAVLinkPacket pack() {
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_MAVNET_STATE_ROVER;
    ...
    /**
     * Decode a mavnet_state_rover message into this class fields
     *
     ...
     */
    public msg_mavnet_state_rover() {
        msgid = MAVLINK_MSG_ID_MAVNET_STATE_ROVER;
    }
     ...
     *
     */
    public msg_mavnet_state_rover(MAVLinkPacket mavLinkPacket) {
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_MAVNET_STATE_ROVER;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_MAVNET_STATE_ROVER - sysid:"+sysid+" compid:"+compid+" state_sequence:"+state_sequence+" time_usec:"+time_usec+" command_sequence:"+command_sequence+" destination_latitude:"+destination_latitude+" destination_longitude:"+destination_longitude+" destination_altitude_ahl:"+destination_altitude_ahl+" target_latitude:"+target_latitude+" target_longitude:"+target_longitude+" target_altitude_ahl:"+target_altitude_ahl+" home_latitude:"+home_latitude+" home_longitude:"+home_longitude+" home_altitude_amsl:"+home_altitude_amsl+" estimated_run_time:"+estimated_run_time+" interval:"+interval+" offset:"+offset+" duration:"+duration+" rally_point_1_latitude:"+rally_point_1_latitude+" rally_point_1_longitude:"+rally_point_1_longitude+" rally_point_2_latitude:"+rally_point_2_latitude+" rally_point_2_longitude:"+rally_point_2_longitude+" mission_delay:"+mission_delay+" custom_mode:"+custom_mode+" latitude:"+latitude+" longitude:"+longitude+" altitude_amsl:"+altitude_amsl+" groundspeed:"+groundspeed+" rally_point_1_ahl:"+rally_point_1_ahl+" rally_point_2_ahl:"+rally_point_2_ahl+" mission_sequence:"+mission_sequence+" heading:"+heading+" voltage_battery:"+voltage_battery+" system_temperature:"+system_temperature+" system_type:"+system_type+" subscription:"+subscription+" pause:"+pause+" speed:"+speed+" flags:"+flags+" param_hash:"+param_hash+" mission_id:"+mission_id+" mission_active:"+mission_active+" mission_upload:"+mission_upload+" transmit_interface:"+transmit_interface+" los_rssi:"+los_rssi+" cellular_rssi:"+cellular_rssi+" satellite_rssi:"+satellite_rssi+" base_mode:"+base_mode+" system_status:"+system_status+" gps_fix_type:"+gps_fix_type+" gps_satellites_visible:"+gps_satellites_visible+" battery_remaining:"+battery_remaining+"";
    }
}
