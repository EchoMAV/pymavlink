...
public class CRC {
    ...
    static {
        ...
        MAVLINK_MESSAGE_CRCS.put(43000, 173);
        MAVLINK_MESSAGE_CRCS.put(43001, 87);
        MAVLINK_MESSAGE_CRCS.put(43002, 227);
        MAVLINK_MESSAGE_CRCS.put(43004, 121);
        MAVLINK_MESSAGE_CRCS.put(43005, 190);
        MAVLINK_MESSAGE_CRCS.put(43006, 172);
        MAVLINK_MESSAGE_CRCS.put(43007, 125);
        MAVLINK_MESSAGE_CRCS.put(43008, 67);
        MAVLINK_MESSAGE_CRCS.put(43009, 174);
        MAVLINK_MESSAGE_CRCS.put(43010, 12);
        MAVLINK_MESSAGE_CRCS.put(43011, 210);
        MAVLINK_MESSAGE_CRCS.put(43012, 182);
        MAVLINK_MESSAGE_CRCS.put(43013, 199);
        MAVLINK_MESSAGE_CRCS.put(43014, 150);
        MAVLINK_MESSAGE_CRCS.put(43015, 252);
        MAVLINK_MESSAGE_CRCS.put(43016, 74);
